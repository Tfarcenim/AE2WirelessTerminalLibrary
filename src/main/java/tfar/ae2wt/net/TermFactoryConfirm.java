...
public class TermFactoryConfirm implements INamedContainerProvider {

    private final ITerminalHost obj;
    private final ContainerLocator locator;

    public TermFactoryConfirm(WCTGuiObject obj, ContainerLocator locator) {
    ...
    public Container createMenu(int p_createMenu_1_, PlayerInventory p_createMenu_2_, PlayerEntity p_createMenu_3_) {
        ...
        WirelessCraftConfirmContainer c = new WirelessCraftConfirmContainer(p_createMenu_1_, p_createMenu_2_, obj);
