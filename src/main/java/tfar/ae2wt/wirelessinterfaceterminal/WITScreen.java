...
public class WITScreen extends AEBaseScreen<WirelessInterfaceTerminalContainer> implements IUniversalTerminalCapable {
    ...
    public WITScreen(WirelessInterfaceTerminalContainer container, PlayerInventory playerInventory,
